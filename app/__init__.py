...
def create_app():
    ...
    app.add_url_rule('/project_bfx_3', 'project_bfx_3', project_bfx_3, methods=['GET', 'POST'])
    ...
    app.add_url_rule('/project_bfx_evaluation2', 'project_bfx_evaluation2', project_bfx_evaluation2, methods=['POST'])
